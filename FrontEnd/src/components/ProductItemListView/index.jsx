  ...
  return (
    <div className='productItem rounded-md w-[100%] overflow-hidden bg-white text-black shadow-lg flex items-center'>
        <div className='group imgWrapper w-[50%] xl:w-[20%] overflow-hidden  relative'>
            <Link to="/">
              <div className='img h-[50%] xl:h-[20%] overflow-hidden'>
                ...
                <img src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco,u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/a5e44b11-0b0a-4a8a-87bc-a3961bfeee0c/WMNS+AIR+JORDAN+1+LOW.png"  className='w-full h-full object-cover absolute top-[0px] left-[-1000px] opacity-0 transition-all duration-1000 group-hover:left-[0px] group-hover:opacity-100'/>
            ...
            <div className='info p-3'>
                ...
                <Link to="/" className='link transition-all'>Nike Dunk List View</Link>
                </h3>
                <p>Description...</p>
